...
import {deliverData} from '../../data/Data'

const Deliver = () =>{
    return (
        <div className="our-contract ourstroy-component section-spacing-top">
        <Container>
       <Row className="g-4">
            ...
            <div className="image-card-inline">
                ...
                <div className="black-box">
                 <div className="card-content">
                   ...
                   { deliverData.map((item, index)=>{
                            return(<>
                             <h4 > <img src={process.env.PUBLIC_URL+"/images/growth-arrow.svg"} alt="grow icon"/>{item.percentage}</h4>
                             <h5>{item.subtitle}</h5>
                            </>)
                       })}
