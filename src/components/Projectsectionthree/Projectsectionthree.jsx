...
import './Projectsectionthree.css';
import Container from 'react-bootstrap/Container';
import Row from 'react-bootstrap/Row';
import Col from 'react-bootstrap/Col';
import {Link} from "react-router-dom";
import {projectSectionthreedata} from "../../data/Data";

const Projectssectionthree = () =>{
    return (
        <div className="Projects-components projectSectionthree">
             <Container>
                <Row className="custom-padding">
                {
                        projectSectionthreedata.map((item, index)=>{
                        return(
                        <Col md={5}>
