...
import {mobileapdevData} from '../../data/Data'

import Video from '../Video/Video';

const Mobileappdevtwo = () =>{
  
    return(
        <div className="our-contract ourstroy-component bg-grey section-spacing">
        <Container>
       <Row className="g-4">
      
        <Col md={12} lg={6} >
           <div className="lef-Image video-card">
           <Row className="">
              <Col md={7} >
                ...
                <div className="experience-box d-flex">
                  <div className="user-img">
                    ...
                    <div className="user-text">
                     {
                        mobileapdevData.map((item, index)=>{
                            return(<>
...
export default Mobileappdevtwo;